...
// bi-monthly, quarterly) earn the full first-PM flat rate; 4 (four-month) earns
// 75%; 6 (semi-annual) earns half. See @/lib/tech-leads/pm-bonus and migration 095
// for the per-interval rate.
