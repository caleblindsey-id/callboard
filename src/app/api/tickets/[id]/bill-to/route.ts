...
// POST /api/tickets/[id]/bill-to
//
// Manager-only single-ticket bill-to correction for PM tickets. Repoints the
// ticket's customer_id (and clears an orphaned ship-to) via the shared
// safe-repoint helper, which hard-blocks any ticket already keyed in Synergy.
// Mirrors the service-ticket bill-to route and the equipment bill-to control.
export async function POST(
  ...
  try {
    ...
    console.error('tickets/[id]/bill-to POST error:', err)
