...
export default function BillingExport({
  ...
  // BEFORE exporting so it prints on the billing PDF, making it easy to match the
  // exported ticket back to its Synergy record when entering the invoice # later
